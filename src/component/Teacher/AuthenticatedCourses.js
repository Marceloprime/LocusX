...
export default function AuthenticatedCourses(){
    ...
    const search = async() =>{
        ...
        request.open('GET', 'http://class-path-auth.herokuapp.com/my-courses/');
    ...
    const detailsearch = async() =>{
      ...
      request.open('GET',  'http://class-path-auth.herokuapp.com/my-courses/'+id+'/');
    ...
    return (
      <ScrollView scrollEnabled={true} >
        <View>       
          <Text style={styles.head}>Minhas turmas</Text>
